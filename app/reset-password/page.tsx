        ...
        <div className="grid md:grid-cols-[1.1fr_0.9fr]">
          <div className="bg-[#071526] p-8 text-white md:p-12">
            ...
            <div className="mt-10 space-y-4 rounded-3xl border border-slate-700 bg-slate-900/60 p-5">
              <div className="text-sm text-slate-300">Password Guidelines</div>
              <div className="text-2xl font-bold text-green-400">Secure & Protected</div>
              <div className="text-sm text-slate-400">Use at least 8 characters with a mix of letters, numbers and symbols.</div>
            </div>
          </div>
          ...
          <div className="p-8 md:p-12">
            ...
            <div className="mb-6">
              <div className="text-sm font-semibold uppercase tracking-[0.14em] text-blue-600">New Password</div>

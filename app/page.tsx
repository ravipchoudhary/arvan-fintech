    ...
    <PublicShell
      ...
      hero={
        <div className="mt-8 flex flex-wrap gap-3">
          ...
          <Link href="/services" className="rounded-full border border-white/15 px-5 py-3 text-sm font-semibold text-slate-200 transition hover:border-blue-400 hover:text-white">Explore Services</Link>
          <Link href="/login" className="rounded-full border border-white/15 px-5 py-3 text-sm font-semibold text-slate-200 transition hover:border-blue-400 hover:text-white">Login</Link>
        </div>
      }
    >
      <section className="rounded-[32px] border border-white/10 bg-slate-900/70 p-8">
        <div className="grid gap-6 lg:grid-cols-4">
          <div className="rounded-2xl border border-white/10 bg-white/5 p-5">
            ...
            <div className="mt-3 text-3xl font-semibold text-white">{totalStrategies}</div>
          </div>
          <div className="rounded-2xl border border-white/10 bg-white/5 p-5">
            <div className="text-sm text-slate-400">Live Algorithms</div>
            <div className="mt-3 text-3xl font-semibold text-white">{liveStrategies}</div>
          </div>
          <div className="rounded-2xl border border-white/10 bg-white/5 p-5">
            <div className="text-sm text-slate-400">Connected Brokers</div>
            <div className="mt-3 text-3xl font-semibold text-white">{connectedBrokers}</div>
          </div>
          <div className="rounded-2xl border border-white/10 bg-white/5 p-5">
            <div className="text-sm text-slate-400">Active Traders</div>
            <div className="mt-3 text-3xl font-semibold text-white">{activeUsers}</div>
          </div>
        </div>
      </section>
      ...
      <section className="mt-16 rounded-[32px] border border-white/10 bg-gradient-to-br from-blue-600/20 to-slate-900 p-8 text-center">
        <h3 className="text-3xl font-semibold text-white">Ready to bring structure to your trading workflow?</h3>
        <p className="mx-auto mt-4 max-w-2xl text-lg text-slate-400">Explore the platform, review the pricing and start from the existing login or signup experience.</p>
        <div className="mt-8 flex flex-wrap justify-center gap-3">
          <Link href="/pricing" className="rounded-full bg-blue-600 px-5 py-3 text-sm font-semibold text-white transition hover:bg-blue-500">View Pricing</Link>
